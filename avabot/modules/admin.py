...
from avabot import dispatcher, TOKEN
from avabot.modules.disable import DisableAbleCommandHandler
from avabot.modules.helper_funcs.chat_status import bot_admin, can_promote, user_admin, can_pin, connection_status
...
*Admin only:*
 ...
 - /invitelink (or) /link: gets invitelink
