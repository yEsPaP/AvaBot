...
from avabot import dispatcher, LOGGER, DEV_USERS, BAN_STICKER, UNBAN_STICKER
from avabot.modules.disable import DisableAbleCommandHandler
from avabot.modules.helper_funcs.chat_status import (bot_admin, user_admin, is_user_ban_protected, can_restrict,
                                                     is_user_admin, is_user_in_chat, connection_status)
from avabot.modules.helper_funcs.extraction import extract_user_and_text
from avabot.modules.helper_funcs.string_handling import extract_time
...
*Admin only:*
 ...
 - /kick <userhandle>: to kick a user out of the group, (via handle, or reply)
"""
