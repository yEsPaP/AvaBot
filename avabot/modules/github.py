...
import avabot.modules.helper_funcs.git_api as api
import avabot.modules.sql.git_sql as sql

from avabot import dispatcher, OWNER_ID, LOGGER, SUDO_USERS, SUPPORT_USERS
