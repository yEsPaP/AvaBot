...
import avabot.modules.sql.global_bans_sql as sql
from avabot import dispatcher, OWNER_ID, SUDO_USERS, DEV_USERS, SUPPORT_USERS, WHITELIST_USERS, STRICT_GBAN, GBAN_LOGS, BAN_STICKER, UNBAN_STICKER
from avabot.modules.helper_funcs.chat_status import user_admin, is_user_admin, support_plus
from avabot.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from avabot.modules.helper_funcs.misc import send_to_list
from avabot.modules.sql.users_sql import get_all_chats
...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    try:
        bot.send_message(user_id,
                         ...
                         "If you think that this was a mistake, you may appeal your gban here: @avasupportgroup",
                         parse_mode=ParseMode.HTML)
    except:
