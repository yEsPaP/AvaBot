...
from avabot import dispatcher, WHITELIST_USERS
from avabot.modules.helper_funcs.chat_status import is_user_admin, user_admin, can_restrict, connection_status
from avabot.modules.log_channel import loggable
from avabot.modules.sql import antiflood_sql as sql
...
def flood(bot: Bot, update: Update):
    ...
    if limit == 0:
        ...
        update.effective_message.reply_text(f"I'm currently kicking their asses if they send "
