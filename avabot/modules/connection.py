...
import avabot.modules.sql.connection_sql as sql
from avabot import dispatcher, SUDO_USERS, DEV_USERS, spamfilters
from avabot.modules.helper_funcs import chat_status
