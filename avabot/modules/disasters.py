...
from avabot import dispatcher, WHITELIST_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS, OWNER_ID
from avabot.modules.helper_funcs.chat_status import whitelist_plus, dev_plus
from avabot.modules.helper_funcs.extraction import extract_user
from avabot.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), 'avabot/elevated_users.json')
