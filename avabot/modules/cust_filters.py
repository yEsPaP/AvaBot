...
from avabot import dispatcher, LOGGER
from avabot.modules.disable import DisableAbleCommandHandler
from avabot.modules.helper_funcs.chat_status import user_admin, connection_status
from avabot.modules.helper_funcs.extraction import extract_text
from avabot.modules.helper_funcs.filters import CustomFilters
from avabot.modules.helper_funcs.misc import build_keyboard
from avabot.modules.helper_funcs.string_handling import split_quotes, button_markdown_parser
from avabot.modules.sql import cust_filters_sql as sql
                ...
                try:
                    ...
                    if excp.message == "Unsupported url protocol":
                        message.reply_text("You seem to be trying to use an unsupported url protocol. Telegram "
                                           ...
                                           "again, or ask in @avasupportgroup for help.")
                        ...
                        message.reply_text("This note could not be sent, as it is incorrectly formatted. Ask in "
                                           "@avasupportgroup if you can't figure out why!")
